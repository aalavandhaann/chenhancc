...
public:
	...
	std::vector<EdgePoint>& FindSourceVertex(int indexOfVert, std::vector<EdgePoint>& resultingPath) const;
...
std::vector<EdgePoint>& CExactMethodForDGP::FindSourceVertex(int indexOfVert, vector<EdgePoint>& resultingPath) const
{
	resultingPath.clear();
